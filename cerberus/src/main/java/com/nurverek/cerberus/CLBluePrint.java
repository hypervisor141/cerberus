...
public class BPBase extends FSGBluePrint{
    ...
    protected void createPrograms(){
        ...
        program.modify(new com.shayan.shapecity.ModColor.Uniform(), FSConfig.POLICY_ALWAYS);
        program.modify(new com.shayan.shapecity.ModLight.Point(Gen.GAMMA, null, Gen.BRIGHTNESS, Gen.light, null, com.shayan.shapecity.Material.MATERIAL_WHITE.getGLSLSize()), FSConfig.POLICY_ALWAYS);
